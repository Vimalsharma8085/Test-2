            ...
            <div key={index} className="mb-8 sm:break-inside-avoid">
              <blockquote className="rounded-xl bg-gray-50 p-6 shadow">
                <p className="leading-relaxed text-gray-700">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Reiciendis nulla quo ipsum cum ullam voluptatum, harum esse autem soluta corrupti et explicabo, excepturi sed nobis numquam similique. Omnis, eligendi similique.
                </p>
              </blockquote>
